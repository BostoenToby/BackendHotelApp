...
public interface IHotelRepository
{
    ...
    Task<Hotel> GetHotelId(string Id);
    Task<List<Hotel>> GetHotelsByCity(string City);
    Task<List<Hotel>> GetHotelsByCityAndStars(int Stars, string City);
...
public class HotelRepository : IHotelRepository
{
    ...
    public async Task<Hotel> GetHotelId(string Id) => await _context.HotelsCollection.Find<Hotel>(c => c.Id == Id).FirstOrDefaultAsync();
    ...
    public async Task<List<Hotel>> GetHotelByProvinceAndStars(int Stars, string Province) => await _context.HotelsCollection.Find<Hotel>(c => (c.StarRating >= Stars) && (c.Province == Province)).ToListAsync();
    public async Task<List<Hotel>> GetHotelsByCityAndStars(int Stars, string City) => await _context.HotelsCollection.Find<Hotel>(c => (c.StarRating >= Stars) && (c.City == City)).ToListAsync();
    ...
    public async Task<Hotel> UpdateHotel(Hotel hotel)
    {
        try
        {
            ...
            return await GetHotelId(hotel.Id);
        }
        catch (Exception ex)
        {
